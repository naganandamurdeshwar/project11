        ...
        <div className='main'>
            ...
            <div className='m4'>
                ...
                <div className='bottom8'>
                    ...
                    <div className='bt2'>
                        ...
                        <div className='j2'>
                             <p className='text4'>TV Artists</p>
                        </div>
                        <div className='j3'>
                            <div className='o1'>
                                 <img src={img5} alt="" className='s1' />
                    ...
                    <div className='bt2'>
                        ...
                        <div className='j3'>
                            ...
                            <div className='o2'>
                             ...
                             <div className='o3'>
                                 <p className='text7'>$6,000</p>
                             </div>
                        </div>
                    </div>
                </div>
                <div className='bottom12'>
                    <button className='book-btn12'>BOOK NOW</button>
                    <div className='bt1'>
            ...
            <div className='m4'>
                <div className='bottom13'>
                     <button className='book-btn13'>BOOK NOW</button>
                    <div className='bt1'>
                    ...
                    <div className='bt2'>
                        ...
                        <div className='j3'>
                            ...
                            <div className='o2'>
                             ...
                             <div className='o3'>
                                 <p className='text7'>$5,000</p>
                             </div>
                        </div>
                    </div>
                </div>
                <div className='bottom14'>
                    <button className='book-btn14'>BOOK NOW</button>
                    <div className='bt1'>
                    ...
                    <div className='bt2'>
                        ...
                        <div className='j3'>
                            ...
                            <div className='o2'>
                             ...
                             <div className='o3'>
                                 <p className='text7'>$1,800</p>
                             </div>
                        </div>
                    </div>
                </div>
                <div className='bottom15'>
                     <button className='book-btn15'>BOOK NOW</button>
                    <div className='bt1'>
                ...
                <div className='bottom16'>
                    <button className='book-btn16'>BOOK NOW</button>
                    <div className='bt1'>
                    ...
                    <div className='bt2'>
                        ...
                        <div className='j3'>
                            ...
                            <div className='o2'>
                                <img src={img6} alt="" className='k2' />
                                <p className='text8'>48hours</p>
                            </div>
                             <div className='o3'>
                                 <p className='text7'>$8,000</p>
                             </div>
                        </div>
                    </div>
                </div>
            ...
            <div className='m4'>
                <div className='bottom17'>
                    <button className='book-btn17'>BOOK NOW</button>
                    <div className='bt1'>
                    ...
                    <div className='bt2'>
                        ...
                        <div className='j3'>
                            ...
                            <div className='o2'>
                             ...
                             <div className='o3'>
                                 <p className='text7'>$6,500</p>
                             </div>
                        </div>
                    </div>
                </div>
                <div className='bottom18'>
                    <button className='book-btn18'>BOOK NOW</button>
                    <div className='bt1'>
                    ...
                    <div className='bt2'>
                        ...
                        <div className='j3'>
                            ...
                            <div className='o2'>
                             ...
                             <div className='o3'>
                                 <p className='text7'>$4,500</p>
                             </div>
                        </div>
                    </div>
                </div>
                <div className='bottom19'>
                    <button className='book-btn19'>BOOK NOW</button>
                    <div className='bt1'>
                ...
                <div className='bottom20'>
                    <button className='book-btn20'>BOOK NOW</button>
                    <div className='bt1'>
